...
#                        of executable (1/0)?
MODEL                = motor
MODULES              = main.c motor_TIM.c
MODULES_OBJ          = main.obj motor_TIM.obj 
MAKEFILE             = motor.mk
...
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 DOWNLOADAPPLICATION=1 STM32CUBEMXPATHUPDATE=1 STM32CUBEMXPATH="E:\stm32_hal\install" TARGET_INST_FULLPATH="E:\MATLAB\STM32-MAT\STM32" IOC_FULLPATH=".\..\encoder\mat_motor\motor_st\motor_st.ioc" IT_HANDLER_OPTIM=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB             = motorlib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = motor_ref.rsp
MODELREF_INC_PATH         =  
...
ADD_INCLUDES = \
	...
	-IC:/Users/zqx/Desktop/motor_simulation/motor_stm32 \
